...
// hours at the specified city
 function writeWeatherData(data) {
  ...
  document.querySelector('#tempData').innerHTML = convertKelvin(data[0].main.temp, city.value)
  document.querySelector('#humidData').innerHTML = (data[0].main.humidity)
  document.querySelector('#conditionsData').innerHTML= (data[0].weather[0].description)
